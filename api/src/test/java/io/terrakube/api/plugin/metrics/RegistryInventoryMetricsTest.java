...
class RegistryInventoryMetricsTest {
    ...
    void registersOneModuleGaugeSeriesPerOrganization() {
        ...
        when(moduleRepository.countByOrganization()).thenReturn(List.of(
                new Object[] {a, 3L}, new Object[] {b, 1L}));
        when(providerRepository.countByOrganization()).thenReturn(List.of(new Object[] {a, 2L}));
    ...
    void secondRefreshUpdatesValues() {
        UUID a = UUID.fromString("00000000-0000-0000-0000-0000000000a1");
        when(moduleRepository.countByOrganization()).thenReturn(List.of(new Object[] {a, 3L}));
        when(providerRepository.countByOrganization()).thenReturn(List.of());
        metrics.refresh();

        when(moduleRepository.countByOrganization()).thenReturn(List.of(new Object[] {a, 5L}));
        metrics.refresh();
