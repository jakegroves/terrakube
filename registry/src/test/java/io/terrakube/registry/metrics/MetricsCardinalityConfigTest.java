...
class MetricsCardinalityConfigTest {
    ...
    void capsTheOrganizationTagOnAnyMeter() {
        ...
        Timer.builder("terrakube.registry.download").tag("organization", "a").register(registry);
        Timer.builder("terrakube.registry.download").tag("organization", "b").register(registry);
        Timer.builder("terrakube.registry.download").tag("organization", "c").register(registry);
        assertThat(registry.find("terrakube.registry.download").timers()).hasSize(2);
    }
